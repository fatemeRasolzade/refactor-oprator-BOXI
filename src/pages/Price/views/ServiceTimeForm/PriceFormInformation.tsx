  ...
  return (
    <>
      <div className="inputRow">
        ...
        />
        <DatePickers important title="تاریخ نرخ نامه" values={values.priceListDate} name="priceListDate" handleChange={setFieldValue} />
        <div className="mb-5 w-60 centering">
          <CustomSwitch active={values.isActive} handleChange={() => setFieldValue("isActive", !values.isActive)} />
        </div>
      </div>
      <div className="inputRow">
        <DatePickers important title="تاریخ اعتبار از" values={values.validDateFrom} name="validDateFrom" handleChange={setFieldValue} />
        <DatePickers important title="تاریخ اعتبار تا" values={values.validDateTo} name="validDateTo" handleChange={setFieldValue} />
      </div>
    </>
  );
};
