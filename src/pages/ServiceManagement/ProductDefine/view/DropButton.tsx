  ...
  return (
    <div className="relative" ref={myRef}>
      <SimpleButton
        ...
        text="افزودن"
        className="full-tomato-btn w-160 h-[40px] centering rounded-lg text-white"
        icon={!toggleIcon ? <BiChevronDown color="white" size={25} /> : <BiChevronUp color="white" size={25} />}
      />
