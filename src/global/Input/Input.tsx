...
const InputText = ({title,placeHolder,handelChange,name,props,blure,values}:{title?:string,icon?:JSX.Element,placeHolder?:string,handelChange?:React.ChangeEventHandler<HTMLInputElement>,name?:string,id?:string,props?:any,blure?:React.FocusEventHandler<HTMLInputElement>,values?: any}) => {
  return (
